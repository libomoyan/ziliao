...
<body style="background:url('img/other/shouye.png') no-repeat">
 ...
 <table width="100%" border="0">
   <tr height="74"><td align="center" colspan="6"> 
    <h1>欢迎来到自由鸟自行车租赁中心</h1>
     </td></tr>
     <tr>
     <td align="right">
     <a href="pagination.jsp" target="mainFrame"><img border="0" id="zy" src="img/top/zy1.gif" 
     ...
     <a href="customerzc.jsp" target="mainFrame"><img border="0" 
	 ...
	 src="img/top/yhzc1.gif"  style="cursor:hand" /></a>
	 <a href="customermanage.jsp" target="mainFrame"><img border="0" 
	 ...
	 src="img/top/yhdl11.gif" style="cursor:hand" /></a>
	 <a href="customerpwchange.jsp" target="mainFrame"><img border="0" 
	 ...
	 src="img/top/mmcz1.gif" style="cursor:hand" /></a>
     ...
     onmouseout="document.all.gw.src='img/top/gwc1.gif'"/></a>
     <a href="ddbiao.jsp" target="mainFrame"><img border="0" 
     ...
     onmouseout="document.all.dd.src='img/top/wddd1.gif'"/></a>
	 <a href='CustomerServlet?action=logout' target="mainFrame"><img border="0" 
